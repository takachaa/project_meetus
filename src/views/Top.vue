  ...
  <!--header-->
	<header class="l-header">
		<div class="p-header">
			...
			<div class="p-header__login"><img src="../img/icon_login.svg" alt="ログイン" class="p-header__login__icon"></div>
		</div>
	</header>
	<!--/header-->
				...
				<section id="searchform">
					...
					<div class="l-main__section">
						...
						<div class="l-main__contents">
							...
							<a class="p-form__detailopen u-fbox u-fbox--alcenter" v-bind:class="{ 'is-active': isSearchDetailActive }" @click="openSearchDetail">より詳細な検索条件を指定</a>
						</div>
						<!--/contents-->
					</div>
					<!--/section-->
					...
					<div class="l-main__section">
						...
						<div class="l-main__contents">
							...
							<div class="p-offer">
								...
								<h1 class="p-offer__title">100%自社開発！北九州で腰を据えて働こう</h1>
							...
							<div class="p-offer">
								<div class="p-offer__thumbnail">
									<img src="../img/img_company01.png" alt="" class="p-offer__thumbnail__img">
									<span class="p-offer__thumbnail__iconbox u-fbox u-fbox--alstart u-fbox--wauto">
										<span class="p-offer__thumbnail__iconbox__icon p-offer__thumbnail__iconbox__icon--good is-active"></span>
										<span class="p-offer__thumbnail__iconbox__icon p-offer__thumbnail__iconbox__icon--favorite is-active"></span>
									</span>
								</div>
								<div class="p-offer__cat u-fbox u-fbox--alstart u-fbox--bxstart">
									<span class="p-offer__cat__icon">正社員</span>
