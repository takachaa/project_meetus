							...
							<div class="p-offer p-offer--detail">
								<div class="p-offer__thumbnail">
									...
									<swiper class="swiper" :options="swiperOption">
										<swiper-slide class="slide-1"><img src="../img/img_company01.png" alt="" class="p-offer__thumbnail__img"></swiper-slide>
										<swiper-slide class="slide-2"><img src="../img/img_company02.png" alt="" class="p-offer__thumbnail__img"></swiper-slide>
										<swiper-slide class="slide-3"><img src="../img/img_company03.png" alt="" class="p-offer__thumbnail__img"></swiper-slide>
										<swiper-slide class="slide-4"><img src="../img/img_company01.png" alt="" class="p-offer__thumbnail__img"></swiper-slide>
										<swiper-slide class="slide-5"><video width="384" height="141" controls src="https://res.cloudinary.com/code-kitchen/video/upload/v1555082747/movie.mp4"></video></swiper-slide>
